...
local train_speed_module = {
	...
	icon = graphics .. "equipment/train-speed-module.png",
	icon_size = 64,
...
local train_productivity_module = {
	...
	icon = graphics .. "equipment/train-productivity-module.png",
	icon_size = 64,
...
local train_efficiency_module = {
	...
	icon = graphics .. "equipment/train-efficiency-module.png",
	icon_size = 64,
...
local train_battery_module = {
	...
	icon = graphics .. "equipment/train-battery-module.png",
	icon_size = 64,
...
local train_battery_module_mk2 = {
	...
	icon = graphics .. "equipment/train-battery-module-mk2.png",
	icon_size = 64,
...
local train_battery_module_mk3 = {
	...
	icon = graphics .. "equipment/train-battery-module-mk3.png",
	icon_size = 64,
